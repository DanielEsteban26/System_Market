    ...
    public partial class RegisterWindow : Window
    {
        ...
        public RegisterWindow()
        {
            ...
            try
            {
                ...
                {
                    // Primera creación permitida (sin pedir clave admin)
                ...
                else if (count == 0)
                {
                    ...
                    // por seguridad mostramos el campo de clave admin (aunque no debería haber admin)
        ...
        private void BtnRegistrar_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    // Validar clave de algún Administrador
